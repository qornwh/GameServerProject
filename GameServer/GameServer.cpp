...
int main()
{
    ...
    const wchar_t* query = L"SELECT accountCode, id, pwd FROM Account WHERE id = ? AND pwd = ?";
    ...
    result = conn->BindParameter(1, SQL_PARAM_INPUT, SQL_C_WCHAR, SQL_WVARCHAR, sizeof(id), 0, (SQLPOINTER)id, 0, nullptr);
