...
// string text = 1;
inline void Login::clear_text() {
  _impl_.text_.ClearToEmpty();
}
inline const std::string& Login::text() const {
  // @@protoc_insertion_point(field_get:protocol.Login.text)
  return _internal_text();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Login::set_text(ArgT0&& arg0, ArgT... args) {
 
 _impl_.text_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:protocol.Login.text)
}
inline std::string* Login::mutable_text() {
  std::string* _s = _internal_mutable_text();
  // @@protoc_insertion_point(field_mutable:protocol.Login.text)
  return _s;
}
inline const std::string& Login::_internal_text() const {
  return _impl_.text_.Get();
}
inline void Login::_internal_set_text(const std::string& value) {
  
  _impl_.text_.Set(value, GetArenaForAllocation());
}
inline std::string* Login::_internal_mutable_text() {
  
  return _impl_.text_.Mutable(GetArenaForAllocation());
}
inline std::string* Login::release_text() {
  // @@protoc_insertion_point(field_release:protocol.Login.text)
  return _impl_.text_.Release();
}
inline void Login::set_allocated_text(std::string* text) {
  if (text != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:protocol.Login.text)
}
